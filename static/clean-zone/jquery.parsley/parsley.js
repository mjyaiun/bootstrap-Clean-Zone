    ...
    */
    this.messages = {
      ...
      , type: {
          ...
          , char:       "This value should be a char except for '\r' and '\n'."
          , hex:        "This value should be a hex char."
          , time:       "This value should be a valid datetime (YYYYMMDDhhmmss)."
        }
      , length:         "This value should have %s characters."
  ...
  Validator.prototype = {
    ...
    */
    , validators: {
      length: function () {
          return {
              validate: function ( val, length, type) {
            	if (type.$element.attr("parsley-type")==="hex"){
            		return val.length/2 === length;
            	}
          ...
          validate: function ( val, type ) {
            ...
            switch ( type ) {
              ...
              case 'phone':
                ...
                break;
              case 'hex':
              	regExp = /^([0-9a-f][0-9a-f])+$/i;
              	break;
              case 'time':
//            	  /^\d{4,}(?:0?\d|1[12])(?:[012]?\d|3[01])(?:[01]?\d|2[0-4])(?:[0-5]?\d|60)(?:[0-5]?\d|60)$/;
            	regExp = /^\d{4}(?:0\d|1[12])(?:[012]\d|3[01])(?:[01]\d|2[0-3])(?:[0-5]\d)(?:[0-5]\d)$/;
                break;
              default:
                return false;
            }
